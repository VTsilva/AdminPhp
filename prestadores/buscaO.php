...
if ($clausula == 1) {
    ...
    $busca = $_POST['buscasta'];
} elseif ($clausula == 3) {
    $busca = $_POST['buscadat'];
}

$bOrcas = buscaOrca($conexao, $idLoja, $clausula, $busca, $inicio, $qnt_result_pg);

$nbOrca = nBuscaOrca($conexao, $idLoja, $clausula, $busca, $inicio, $qnt_result_pg);

$quantidade_pg = quantidadePg($qnt_result_pg, nBuscaOrca($conexao, $idLoja, $clausula, $busca, $inicio, $qnt_result_pg));
    ...
    <section class="home-section">
        ...
        <div class="busca">
            <form action="buscaO.php" method="post" class="frm-busca">
                <!-- id da loja -->
                <input type="text" style="display: none;" name="idLoja" value="<?php echo $idLoja; ?>">
        ...
        <section class="table100">
            <div class="quadro">
                <div>
                    <h3 class="qtd">Quantidade de Orçamentos realizados: <?php echo implode(",", $nbOrca) ?></h3>
                </div>
                ...
                <table class="table">
                    ...
                    <?php foreach ($bOrcas as $bOrca) : ?>
                        <tr>
                            <form action="verOrca.php" method="post">
                                <td class="column1"> <input type="text" name="idOrca" value="<?php echo $bOrca['ID']; ?>"></td>
                                <td class="column4"> <?php echo $bOrca['CLIENTE']; ?> </td>
                                <td class="column1"> <?php echo $bOrca['IDCLIENTE']; ?> </td>
                                <td class="column4"> <?php echo $bOrca['LOJA']; ?> </td>
                                <td class="column1"> <?php echo $bOrca['IDLOJA']; ?></td>
                                <td class="column4"> <?php echo $bOrca['STATUS']; ?> </td>
                                <td class="column4"> <?php echo $bOrca['VALORTOTAL']; ?> </td>
                                <td class="column1"> <?php echo $bOrca['AVALIACAO']; ?> </td>
                                <td class="column4"> <?php echo $bOrca['DATA']; ?> </td>
